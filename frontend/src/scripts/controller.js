/**
 * Simplewebservice Sift. Frontend controller entry point.
 */
...
export default class MyController extends SiftController {
  ...
  loadView(state) {
    console.log('simplewebservice: loadView', state);
    ...
    switch (state.type) {
      ...
      default:
        console.error('simplewebservice: unknown Sift type: ', state.type);
    }
  }

  // Event: storage update
  // onStorageUpdate(value) {
  //   console.log('simplewebservice: onStorageUpdate: ', value);
  ...
  //     bucket: 'x'
  //   }).then((values) => {
  //     console.log('simplewebservice: getX returned:', values);
  //     return {};
  //   });
  // }
